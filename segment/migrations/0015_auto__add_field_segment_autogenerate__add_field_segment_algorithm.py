...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Segment.autogenerate'
        db.add_column(u'segment_segment', 'autogenerate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Segment.algorithm'
        db.add_column(u'segment_segment', 'algorithm',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Segment.autogenerate'
        db.delete_column(u'segment_segment', 'autogenerate')

        # Deleting field 'Segment.algorithm'
        db.delete_column(u'segment_segment', 'algorithm')
    ...
    models = {
        ...
        u'segment.imagetype': {
            ...
            'folder': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'users_shared': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'users_shared'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"})
        },
        u'segment.segment': {
            'Meta': {'object_name': 'Segment'},
            'algorithm': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'autogenerate': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
