...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Image.folder'
        db.delete_column(u'segment_image', 'folder')

        # Adding field 'ImageType.folder'
        db.add_column(u'segment_imagetype', 'folder',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Image.folder'
        db.add_column(u'segment_image', 'folder',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Deleting field 'ImageType.folder'
        db.delete_column(u'segment_imagetype', 'folder')
