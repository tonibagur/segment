...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field users_shared on 'ImageType'
        m2m_table_name = db.shorten_name(u'segment_imagetype_users_shared')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('imagetype', models.ForeignKey(orm[u'segment.imagetype'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['imagetype_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field users_shared on 'ImageType'
        db.delete_table(db.shorten_name(u'segment_imagetype_users_shared'))
