...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.parent_segment'
        db.add_column(u'segment_image', 'parent_segment',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent_segment', null=True, to=orm['segment.Segment']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Image.parent_segment'
        db.delete_column(u'segment_image', 'parent_segment_id')
